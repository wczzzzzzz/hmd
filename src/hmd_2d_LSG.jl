...
@timeit to "calculate ∫vtdΓ" begin
    ...
    @timeit to "get elements" elements_4t = Seg2toTri3(elements_4,elements)
    # @timeit to "get elements" elements_3t = Seg3toTri6(elements_3,elements)
    # @timeit to "get elements" elements_4t = Seg3toTri6(elements_4,elements)
    ...
    prescribe!(elements_4t, :EA=>(x,y,z)->EA, :ρA=>(x,y,z)->ρA, :α=>(x,y,z)->α)
    @timeit to "calculate shape functions" set𝝭!(elements_1)
    @timeit to "calculate shape functions" set𝝭!(elements_2)
    @timeit to "calculate shape functions" set𝝭!(elements_3)
    @timeit to "calculate shape functions" set𝝭!(elements_4)
    @timeit to "calculate shape functions" set∇𝝭!(elements_3t,elements)
    @timeit to "calculate shape functions" set∇𝝭!(elements_4t,elements)
    𝑓 = ∫vtdΓ=>elements_4
    𝑎ᵅ = ∫vgdΓ=>elements_1
    𝑎ᵅ = ∫vgdΓ=>elements_2
    𝑎ᵝ = ∫vgdΓ=>elements_2
    ...
    𝑎ᵞ = stabilization_bar_LSG_Γ=>elements_4t
