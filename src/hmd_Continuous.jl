using ApproxOperator, XLSX, LinearAlgebra, LinearSolve, GLMakie, WriteVTK
...
# @timeit to "open msh file" gmsh.open("./msh/square/Tri3_64.msh")
# @timeit to "open msh file" gmsh.open("./msh/square/Tri6_4")
@timeit to "open msh file" gmsh.open("./msh/BiRefine/Continuous/square_4_r3_refined.msh")
...
# vtk_grid("./vtk/hmd_Continuous/uniform_64.vtu",points,cells) do vtk
